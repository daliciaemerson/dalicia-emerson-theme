    ...
    <aside class="de-walmart-page__sidebar" role="complementary">
      <div class="de-agent-card">
        <img src="<?php echo esc_url( get_theme_file_uri( '/assets/images/dalicia-headshot.jpg' ) ); ?>"
             alt="Dalicia Emerson, NWA Corporate Relocation REALTOR®"
             width="120" height="120" class="de-agent-card__photo">
        ...
        <p class="de-agent-card__note" style="color:var(--de-gold);">Corporate Relocation Specialist</p>
